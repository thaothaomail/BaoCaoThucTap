	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                ...
                <a class="fa fa-google" href="https://www.google.com"></a>
...
function addFooter() {
  document.write(`
    ...
    <div class="copy-right">
        <p><a href="index.html">Phone Store</a> - All rights reserved ©  - Designed by
            <span style="color: #eee; font-weight: bold">Thanh Thao</span></p>
    </div>`);
}
